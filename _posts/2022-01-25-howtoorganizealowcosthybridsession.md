...
[^2]: We note that this might not be possible for blind/deaf participants. In this case, we should implement specialized solutions—subtitles generators, oral descriptions of the slides, etc.—ßto compensate for the problems produced by not seeing or hearing the presentation. As we don't have any experience with this, our low-cost solution will assume that there are no blind/deaf participants.
